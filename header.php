...
<head>
	...
	?>
	<?php wp_head(); ?>
	<link rel="stylesheet" href="https://<?php echo iro_opt('gfonts_api', 'fonts.googleapis.com'); ?>/css2?family=Noto+Serif|Noto+Serif+SC|Noto+Sans+SC|Dela+Gothic+One|Fira+Code<?php echo iro_opt('gfonts_add_name'); ?>:wght@200..900&display=swap" media="all">
